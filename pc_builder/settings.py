...
SECRET_KEY = 'django-insecure-)$se8v^e=d^&+gsqx#e-k0@2o6hs6ke@i1!4jk$0jq08uho-p&'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pc_app.context_processors.feedback_form_context',
                'pc_app.context_processors.cart_items_count',
            ],
        },
    },
]
